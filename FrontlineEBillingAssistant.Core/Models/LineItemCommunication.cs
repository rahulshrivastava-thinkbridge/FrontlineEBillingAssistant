...
{
    public partial class LineItemCommunication
    {
        ...
        public DateTime? EscalateResponseReceivedDate { get; set; }
        public DateTime? FollowUpResponseReceivedDate { get; set; }
        public string QueryAttachments { get; set; }

        public virtual User AddressedToUser { get; set; }
