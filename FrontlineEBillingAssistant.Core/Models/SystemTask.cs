...
namespace FrontlineEBillingAssistant.Core.Models
{
    public partial class SystemTask
    {
        public SystemTask()
        {
            InverseParentTask = new HashSet<SystemTask>();
            SystemTaskNotes = new HashSet<SystemTaskNote>();
        }
        ...
        public virtual SystemTask ParentTask { get; set; }
        public virtual User TaskRequestingUser { get; set; }
        public virtual ICollection<SystemTask> InverseParentTask { get; set; }
        public virtual ICollection<SystemTaskNote> SystemTaskNotes { get; set; }
    }
}
