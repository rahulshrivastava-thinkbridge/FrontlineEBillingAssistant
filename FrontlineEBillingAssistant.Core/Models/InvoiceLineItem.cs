...
namespace FrontlineEBillingAssistant.Core.Models
{
    public partial class InvoiceLineItem
    {
        ...
        {
            InvoiceLineItemDiscCredInvoiceExpenseLineItems = new HashSet<InvoiceLineItemDiscCred>();
            InvoiceLineItemDiscCredInvoiceFeeLineItems = new HashSet<InvoiceLineItemDiscCred>();
            InvoiceLineItemDiscCredInvoiceLineItems = new HashSet<InvoiceLineItemDiscCred>();
            InvoiceTaxMatterDiscountCredits = new HashSet<InvoiceTaxMatterDiscountCredit>();
            LineItemCommunications = new HashSet<LineItemCommunication>();
        ...
        public virtual ExtendHeader ExtendHeaderModifiedExtendHeader { get; set; }
        public virtual InvoiceMatter InvoiceMatter { get; set; }
        public virtual InvoiceMatter InvoiceMatterId1Navigation { get; set; }
        public virtual InvoiceMatter InvoiceMatterId2Navigation { get; set; }
        public virtual InvoiceMatter InvoiceMatterId3Navigation { get; set; }
        public virtual Rule Rule { get; set; }
        public virtual RuleCategory RuleCategory { get; set; }
        public virtual LawFirmContactPerson Timekeeper { get; set; }
        public virtual ICollection<InvoiceLineItemDiscCred> InvoiceLineItemDiscCredInvoiceExpenseLineItems { get; set; }
        public virtual ICollection<InvoiceLineItemDiscCred> InvoiceLineItemDiscCredInvoiceFeeLineItems { get; set; }
        public virtual ICollection<InvoiceLineItemDiscCred> InvoiceLineItemDiscCredInvoiceLineItems { get; set; }
        public virtual ICollection<InvoiceTaxMatterDiscountCredit> InvoiceTaxMatterDiscountCredits { get; set; }
        public virtual ICollection<LineItemCommunication> LineItemCommunications { get; set; }
